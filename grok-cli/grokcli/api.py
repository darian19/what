...
from YOMPcli.exceptions import (
  YOMPCLIError,
  InvalidYOMPHostError,
  InvalidCredentialsError)



class YOMPCustomContextManager(socket.socket):
  """ Helper class for establishing a socket connection to YOMP Custom Metric
      endpoint.  See YOMPSession.connect()
  """

  def __init__(self, host, port, *args, **kwargs):
    super(YOMPCustomContextManager, self).__init__(*args, **kwargs)
    self._host = host
    self._port = port
...
class YOMPSession(Session):
  ...
  def __init__(self, server=None, apikey=None, *args, **kwargs):
    super(YOMPSession, self).__init__(*args, **kwargs)
      ...
      if hasattr(e.args[0], "reason"):
        if isinstance(e.args[0].reason, socket.gaierror):
          if e.args[0].reason.args[0] == socket.EAI_NONAME:
            raise InvalidYOMPHostError("Invalid hostname")
    except (InvalidURL, MissingSchema) as e:
      raise InvalidYOMPHostError("Invalid hostname")


  def connect(self):
    """ Helper function for establishing a socket connection to YOMP Custom
        Metric endpoint given a YOMPSession instance.  Use as a Context Manager
        to ensure that connection is gracefully shutdown:

          YOMP = YOMPSession(server="...", apikey="...")

          with YOMP.connect() as sock:
            sock.sendall("{metric name} {metric value} {unix timestamp}\n")
    """
    parseResult = urlparse(self.server)
    return YOMPCustomContextManager(parseResult.netloc, 2003)
  ...
  def verifyCredentials(self, aws_access_key_id, aws_secret_access_key, **kwargs):
    ...
    if response.status_code == 200:
      ...
      raise InvalidYOMPHostError("Invalid protocol")
  ...
  def updateSettings(self, settings, section=None, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to update settings.", response)
  ...
  def listMetricDatasources(self, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to list metric datasources.", response)
  ...
  def listMetrics(self, datasource, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to list metrics.", response)
  ...
  def listModels(self, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to list models.", response)
  ...
  def listInstances(self, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to list instances.", response)
  ...
  def listAutostacks(self, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to list autostacks.", response)
  ...
  def exportModels(self, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to export models.", response)
  ...
  def exportModel(self, modelId, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to export model.", response)
  ...
  def createModels(self, nativeMetric, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to create models.", response)
  ...
  def createModel(self, nativeMetric, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to create model.", response)
  ...
  def createInstance(self, region, namespace, instanceID, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to create instance.", response)
  ...
  def previewAutostack(self, region, filters, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to preview autostack.", response)
  ...
  def createAutostack(self, name, region, filters, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to create autostack.", response)
  ...
  def addMetricToAutostack(self, stackID, metricNamespace, metricName, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to add metric to autostack.", response)
  ...
  def deleteModel(self, metricID, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to delete model.", response)
  ...
  def deleteInstance(self, serverName, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to delete instance.", response)
  ...
  def deleteAutostack(self, stackID, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to delete autostack.", response)
  ...
  def removeMetricFromAutostack(self, stackID, metricID, **kwargs):
    ...
    raiseError(YOMPCLIError, "Unable to remove metric from autostack.",
               response)
