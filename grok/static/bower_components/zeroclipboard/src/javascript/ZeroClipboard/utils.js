 ...
 * because ExternalInterface fails when Flash is cached in IE.
 *
...
var _deprecationWarning = function(deprecatedApiName, debugEnabled) {
  if (deprecatedApiName && debugEnabled !== false && typeof console !== "undefined" && console && (console.warn || console.log)) {
    var deprecationWarning = "`" + deprecatedApiName + "` is deprecated. See docs for more info:\n" +
          "    https://YOMPhub.com/zeroclipboard/zeroclipboard/blob/master/docs/instructions.md#deprecations";
    if (console.warn) {
...
/*
 * Extract the domain (e.g. "YOMPhub.com") from an origin (e.g. "https://YOMPhub.com") or
 * URL (e.g. "https://YOMPhub.com/zeroclipboard/zeroclipboard/").
 * @returns the domain
 * @private
 */
