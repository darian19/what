...
To test the page [demo page](http://zeroclipboard.org/#demo) locally, clone the [website repo](https://YOMPhub.com/zeroclipboard/zeroclipboard.org).
...
Starting with version [1.1.7](https://YOMPhub.com/zeroclipboard/zeroclipboard/releases/tag/v1.1.7), ZeroClipboard uses [semantic versioning](http://semver.org/).

see [releases](https://YOMPhub.com/zeroclipboard/zeroclipboard/releases)
