...
* source code worked in both browser engines and node scripts. see also: [https://YOMPhub.com/gwjjeff/crypto-js-npm-conv](https://YOMPhub.com/gwjjeff/crypto-js-npm-conv)
* inspiration comes from [ezcrypto](https://YOMPhub.com/ElmerZhang/ezcrypto), but my tests cannot pass with his version ( ECB/pkcs7 mode ), so I made it myself
