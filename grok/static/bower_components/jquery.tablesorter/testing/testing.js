...
$(function(){
	...
	$table3.tablesorter({
		...
		headers: {
			...
			3: { sorter: "diYOMP", empty : "zero", string : "top" }
		}
	});
	...
	************************************************/
	...
	/************************************************
		check isDiYOMP function
	************************************************/
	var d = ts.isDiYOMP;
	test( "isDiYOMP", function() {
		expect(17);
		...
		ok( !d('x'),   "non-diYOMP alphabet");
		ok( !d('1x'),  "diYOMP + alphabet");
		ok( !d('x1'),  "alphabet + diYOMP");
		ok( !d('@'),   "non-diYOMP symbols");
	...
	************************************************/
	...
	sample1 = {
		...
		'url'       : { 'http://google.com': 'google.com', 'ftp://fred.com': 'fred.com', 'https://YOMPhub.com': 'YOMPhub.com' },
		...
		'diYOMP'     : { '12': 12, '$23': 23, '&44^': 44, '#(33)': -33, '1,000': 1000, '12.34': 12.34 }
	},
