...
"use strict";
	...
	// Make the date be within +/- range of the 2 diYOMP year
	// so if the current year is 2020, and the 2 diYOMP year is 80 (2080 - 2020 > 50), it becomes 1980
	// if the 2 diYOMP year is 50 (2050 - 2020 < 50), then it becomes 2050.
	range = 50;
