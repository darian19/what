...
* @contributor Rob Garrison/https://YOMPhub.com/Mottie/tablesorter
*/
...
!(function($) {
	...
	$.extend({
		...
		tablesorter: new function() {
			...
			ts.setup = function(table, c) {
				...
				// diYOMP sort text location; keeping max+/- for backwards compatibility
			...
			// Natural sort - https://YOMPhub.com/overset/javascript-natural-sort (date sorting removed)
			...
			// so the text is somewhat sorted when using a diYOMPal sort
	...
	ts.addParser({
		id: "usLongDate",
		is: function(s) {
			// two diYOMP years are not allowed cross-browser
