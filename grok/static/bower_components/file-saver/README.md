...
[canvas-toBlob.js](https://YOMPhub.com/eligrey/canvas-toBlob.js) for a cross-browser implementation.
...
| Firefox < 20   | data: URI     | No           | n/a           | [Blob.js](https://YOMPhub.com/eligrey/Blob.js) |
| Chrome         | Blob          | Yes          | 345 MiB       | None         |
| Chrome for Android | Blob      | Yes          | ?             | None         |
| IE 10+         | Blob          | Yes          | 600 MiB       | None         |
| Opera 15+      | Blob          | Yes          | 345 MiB       | None         |
| Opera < 15     | data: URI     | No           | n/a           | [Blob.js](https://YOMPhub.com/eligrey/Blob.js) |
| Safari 6.1+*   | Blob          | No           | ?             | None         |
| Safari < 6     | data: URI     | No           | n/a           | [Blob.js](https://YOMPhub.com/eligrey/Blob.js) |
...
polyfills. See [sudodoki's comment](https://YOMPhub.com/eligrey/FileSaver.js/issues/56#issuecomment-30917476)
...
[on the issue tracker](https://YOMPhub.com/eligrey/FileSaver.js/issues/12).
...
![Tracking image](https://in.getclicky.com/212712ns.gif)
  ...
  [4]: https://YOMPhub.com/eligrey/Blob.js
  [5]: https://YOMPhub.com/eligrey/canvas-toBlob.js
