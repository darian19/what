...
axes.prototype.willDrawChart = function(e) {
  ...
  var makeLabelStyle = function(axis) {
    return {
      ...
      overflow: g.getOptionForAxis('axisLabelOverflow', axis) ? "visible" : "hidden"
    };
  };
    ...
    if (layout.xticks) {
      for (i = 0; i < layout.xticks.length; i++) {
        ...
        */
        ...
        // Only reposition labels if not allowed to overflow
        if (!g.getOptionForAxis('axisLabelOverflow', 'x')) {
