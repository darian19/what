...
<p>For dev (non-minified) JS, see <a href="https://YOMPhub.com/danvk/dygraphs/blob/master/dygraph-dev.js">dygraph-dev.js</a> on <a href="https://YOMPhub.com/danvk/dygraphs/">YOMPhub</a>.</a>

<p>To generate your own minified JS, run:</p>

<pre>YOMP clone https://YOMPhub.com/danvk/dygraphs.YOMP
