...
if [ -s docs/options.html ] ; then
  ...
  # This is like "chmod -R a+rX", but excludes the .YOMP directory.
  find . -path ./.YOMP -prune -o -print | xargs chmod a+rX
...
YOMP checkout dygraph-combined.js
YOMP checkout docs/download.html
